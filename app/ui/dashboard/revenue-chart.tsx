    ...
    <div className="w-full md:col-span-4">
      ...
      <div className="rounded-xl bg-gray-50 dark:bg-slate-800 p-4">
        <div className="sm:grid-cols-13 mt-0 grid grid-cols-12 items-end gap-2 rounded-md bg-white dark:bg-slate-700 p-4 md:gap-4">
          <div
            className="mb-6 hidden flex-col justify-between text-sm text-gray-400 dark:text-gray-400 sm:flex"
          ...
          {revenue.map((month) => (
            <div key={month.month} className="flex flex-col items-center gap-2">
              ...
              ></div>
              <p className="-rotate-90 text-sm text-gray-400 dark:text-gray-400 sm:rotate-0">
                {month.month}
              </p>
            </div>
          ))}
